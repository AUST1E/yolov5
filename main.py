...
def search():
    ...
    Qualified_Rate = num_Qulified / total_num
    ...
    #柱状图
    source = pd.DataFrame({
    'b': ['Loose_fan_screws','Missing_fan_screws','Loose_board_screws','Board_screw_model_error',
        'Missing_board_screws','Incorrect_fan_wiring'],
    'a': [num_Loose_fan_screws,num_Missing_fan_screws,num_Loose_board_screws,num_Board_screw_model_error,
    ...
    #饼状图
    source = pd.DataFrame({"category": ['Loose_fan_screws','Missing_fan_screws','Loose_board_screws','Board_screw_model_error',
        'Missing_board_screws','Incorrect_fan_wiring'], "value": [num_Loose_fan_screws,num_Missing_fan_screws,num_Loose_board_screws,num_Board_screw_model_error,
    num_Missing_board_screws,num_Incorrect_fan_wiring]})
    ...
    #合格率饼状图
    source = pd.DataFrame({"category": ['Qualified','unQualified'], "value": [num_Qulified,num_unQualified]})
